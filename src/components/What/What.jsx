    ...
    <section className='v-wrapper'>
        <div className="paddings innerWidth flexCenter v-container"> 
            <div className="flexCenter v-right">
                ...
                business strategy. <br/> Our goal is to ensure that educators focus on teaching & learing while our team provides effective & efficient solutions for the day to day operations of your institution.
                </center>
                </span>
            </div>
        </div>
